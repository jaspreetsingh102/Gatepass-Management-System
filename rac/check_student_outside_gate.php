...
WHERE lr.Status = 'Approved' 
  ...
  AND CURDATE() BETWEEN lr.Leaving_Date AND lr.Returning_Date
...
<div class="container">
    <h3 class="text-center mb-4">Active Students Outside the Gate</h3>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <form method="POST" action="" class="px-3 py-1">
                                        ...
                                        <button class="dropdown-item text-info" type="submit" name="status" value="Returned"><i class="fas fa-undo"></i> Returned</button>
                                    </form>
                                </div>
                            </div>
                        </td>
